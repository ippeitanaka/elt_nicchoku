      ...
      try {
        ...
        if (journal.checklist) {
          setChecklist({
            ...
            prints: journal.checklist.prints || false,
            journal: journal.checklist.journal || false,
            supplies: journal.checklist.supplies || false,
          })
        }
              ...
              {checklistItems.map((item) => (
                ...
                >
                  <Checkbox
                    ...
                    className="cute-checkbox  => handleChecklistChange(item.id, checked as boolean)}
